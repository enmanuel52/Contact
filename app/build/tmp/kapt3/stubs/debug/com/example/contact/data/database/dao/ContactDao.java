...
public abstract interface ContactDao {
    ...
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM contact_table WHERE name LIKE \'%\' || :name || \'%\' ORDER BY name ASC")
    public abstract java.util.List<com.example.contact.data.database.entities.ContactEntity> searchByName(@org.jetbrains.annotations.NotNull()
