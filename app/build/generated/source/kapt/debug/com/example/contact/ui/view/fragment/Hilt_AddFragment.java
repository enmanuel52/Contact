 ...
 */
public abstract class Hilt_AddFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddFragment_GeneratedInjector) this.generatedComponent()).injectAddFragment(UnsafeCasts.<AddFragment>unsafeCast(this));
    }
  }
