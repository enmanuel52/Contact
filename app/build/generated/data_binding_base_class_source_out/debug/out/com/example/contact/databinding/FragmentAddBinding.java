...
public final class FragmentAddBinding implements ViewBinding {
  ...
  private FragmentAddBinding(@NonNull LinearLayout rootView, @NonNull Toolbar addToolbar,
  ...
  public static FragmentAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddBinding((LinearLayout) rootView, addToolbar, etName, etNumber);
    }
